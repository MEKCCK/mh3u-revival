...
<div class="grid">
  ...
  <section>
    ...
    <table><thead><tr><th>GID</th><th data-i18n="colHost">房主</th><th data-i18n="colCount">人数</th><th data-i18n="colMode">模式</th><th data-i18n="colAttrib">属性</th><th data-i18n="colMembers">参与者</th></tr></thead>
...
const I18N = {
  zh: { online:"在线玩家", huntRooms:"狩猎房间", roomCap:"房间上限（全服）", connCap:"在线上限（全服）",
        ...
        colHost:"房主", colCount:"人数", colMode:"模式", colAttrib:"属性", colMembers:"参与者",
  ...
  en: { online:"Online Players", huntRooms:"Hunt Rooms", roomCap:"Room Cap (Global)", connCap:"Connection Cap (Global)",
        ...
        colHost:"Host", colCount:"Players", colMode:"Mode", colAttrib:"Attrib", colMembers:"Members",
  ...
  ja: { online:"オンライン", huntRooms:"狩猟部屋", roomCap:"部屋上限（全体）", connCap:"接続上限（全体）",
        ...
        colHost:"ホスト", colCount:"人数", colMode:"モード", colAttrib:"属性", colMembers:"メンバー",
  ...
  ko: { online:"온라인 플레이어", huntRooms:"사냥방", roomCap:"방 상한（전체）", connCap:"접속 상한（전체）",
        ...
        colHost:"방장", colCount:"인원", colMode:"모드", colAttrib:"속성", colMembers:"구성원",
  ...
  fr: { online:"Joueurs en ligne", huntRooms:"Salles de chasse", roomCap:"Limite salles (serveur)", connCap:"Limite connexions (serveur)",
        ...
        colHost:"Hôte", colCount:"Joueurs", colMode:"Mode", colAttrib:"Attr.", colMembers:"Membres",
  ...
  es: { online:"Jugadores online", huntRooms:"Salas de caza", roomCap:"Límite salas (global)", connCap:"Límite conexiones (global)",
        ...
        colHost:"Anfitrión", colCount:"Jugadores", colMode:"Modo", colAttrib:"Atrib.", colMembers:"Miembros",
  ...
  ru: { online:"Игроки онлайн", huntRooms:"Охотничьи комнаты", roomCap:"Лимит комнат (всего)", connCap:"Лимит подключений (всего)",
        ...
        colHost:"Хост", colCount:"Игроков", colMode:"Режим", colAttrib:"Атриб.", colMembers:"Участники",
